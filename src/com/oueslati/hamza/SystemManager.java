...
import com.oueslati.hamza.exception.*;
...
public class SystemManager
{
    ...
    public void createFlight(String n, String orig, String dest, int year, int month, int day, String id) throws FieldLengthException, ObjectExistInHashSetException {
